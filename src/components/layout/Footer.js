  ...
  return (
    <footer className="bg-primary p-8 text-white w-full">
        ...
        <div className="w-full flex flex-col items-center space-y-8">
          ...
          <div className="w-full flex flex-col items-center p-4 rounded-lg newsletter-section">
            ...
            <div className="w-full mb-8 p-4 rounded-sm text-center">
              <p className="text-base md:text-base font-bold leading-relaxed text-white">{t('footer.stayUpdated')}</p>
            </div>
            <Link to="/newsletter">
      ...
      <div className="text-center mt-16 text md:text-lg">
        ...
        <p>Developer: Sabir Maharramov - <a href="mailto:maharram.sabir@gmail.com" className="text-blue-400 underline">maharram.sabir[at]gmail.com</a><br />
          Designer: Pia Chwalczyk - <a href="mailto:piachwalczyk@icloud.com" className="text-blue-400 underline">piachwalczyk[at]icloud.com</a>
        </p>
      </div>
    </footer>
  );
