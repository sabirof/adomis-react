...
import LanguageSwitcher from '../LanguageSwitcher'; // Adjust path if necessary
        ...
        <nav className={`w-full ${menuOpen ? 'block' : 'hidden'} md:w-2/3 ${!isMobile ? 'lg:block' : ''}`}>
          <div className={`container mx-auto flex flex-col ${menuOpen ? 'gap-6 pt-10 ' : 'md:flex-row pt-4'} md:justify-start items-start ${!menuOpen ? 'pl-5' : 'pl-40'} pt-5 gap-4`}>
            <ul className={`text-black flex flex-col ${menuOpen ? 'gap-6' : 'md:flex-row gap-6 '} text-lg`}>
              <li>
                <Link to="/" className="hover:bg-accent p-2 rounded-md transition">
                  {t('navbar.home')}
                </Link>
              </li>
              <li className="relative group">
                <Link to="/project" className="hover:bg-accent p-2 rounded-md transition">
                  {t('navbar.project')}
                </Link>
                <ul className={`absolute ${isMobile ? 'left-full top-0' : 'right-0 mt-2'} md:right-auto md:left-full md:mt-0 md:ml-2 lg:left-0 lg:mt-2 w-40 bg-white border border-gray-200 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300`}>
                  <li>
                    <Link to="/project/interview-details" className="block px-3 py-1 text-sm hover:bg-accent rounded-t-md">
                      {t('navbar.interviewStudies')}
                    </Link>
                  </li>
                  <li>
                    <Link to="/project/survey-details" className="block px-3 py-1 text-sm hover:bg-accent rounded-b-md">
              ...
              <li>
                <Link to="/news" className="hover:bg-accent p-2 rounded-md transition">
                  {t('navbar.news')}
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover:bg-accent p-2 rounded-md transition">
                  {t('navbar.about')}
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:bg-accent p-2 rounded-md transition">
                  {t('navbar.contact')}
                </Link>
              </li>
            </ul>
